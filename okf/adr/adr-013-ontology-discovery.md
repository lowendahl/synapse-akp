...
- New module: `compiler/src/kp_compiler/stages/discover_ontology.py`
- New CLI flag: `--discover-ontology` on `kp compile`
- Ontology output path defaults to `<source_root>/../ontology.yaml`
- Integrates as Stage 0 in the pipeline (before parse)
